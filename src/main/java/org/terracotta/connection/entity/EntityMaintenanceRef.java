 ...
 * @author twu
 */
public interface EntityMaintenanceRef<T extends Entity> {
  ...
  /**
   * Drop maintenance mode status on the referenced entity. This maintenance mode reference will be unusable after the
   * call.
   */
